  ...
  return (
    <>
      ...
      <div className="px-[25px] xl:px-[100px] sm:max-xl:px-[50px]">
          ...
          <div className="text-center text-base md:text-[52px] text-r-blue font-bold">Promoting Positive Peer Relationships: Nurturing Social Skills in Young Minds</div>
          <div className="text-center text-[0.75rem] md:text-sm text-black pb-5"> Rudra Dev    |    September,2023    |    4mins</div>


        <div className="flex items-center justify-center">
          <img src="/Images/blog12.jpg" alt="blog12" className="xl:w-[1000px] xl:h-[500px] w-full h-full rounded-lg" />
        </div>
        ...
        <div className="flex flex-row gap-6 pt-[100px] items-start pb-20 px-[25px] xl:px-[100px] sm:max-xl:px-[50px]">
          <div className="sm:flex flex-col flex-[35%] sticky gap-2 top-20 pl-5 font-normal text-[1rem] text-r-blue cursor-pointer py-[100px] hidden">
            ...
            <a href="#section1">The Significance of Positive Peer Relationships</a>
            <a href="#section2">Strategies for Parents and Educators</a>
          ...
          <div className="flex flex-col flex-[60%] gap-5 pr-0 sm:pr-16 ">
            ...
            <section id="section1">
              ...
              <div>Positive peer relationships have far-reaching effects on students&apos; lives. Let&apos;s explore three key areas where these relationships have a significant impact:<br/>
                ...
                Interacting with peers hones social skills, helping students learn to communicate, empathize, and resolve conflicts. Through positive peer relationships, students develop important abilities such as active listening, cooperation, compromise, and problem-solving. These skills are essential for navigating social situations and building healthy relationships throughout their lives.<br />
                <span className="font-bold text-r-blue">Academic Performance</span> <br />
                Positive peer interactions can enhance the classroom experience, fostering an environment of collaboration and shared learning. When students feel connected to their peers and have positive relationships, they are more likely to actively participate in class, engage in discussions, and contribute to group projects. This collaborative learning environment can lead to improved academic performance and a deeper understanding of the material.<br/>
            ...
            <section id="section2">
              ...
              <div>As educators and parents, there are various strategies you can employ to promote positive peer relationships and nurture students&apos; social skills. Here are some effective approaches:<br/>
                ...
                Offer workshops on identifying bullying behaviors and teaching students effective strategies for addressing and resolving conflicts. By equipping students with the tools to handle these challenging situations, you empower them to create a safe and inclusive environment.<br/>
                ...
                Establish a safe and nonjudgmental environment where students feel comfortable discussing their social experiences and seeking guidance. This safe space allows students to express themselves, share their concerns, and receive support.<br/>
                <span className="font-bold text-r-blue">Encourage Extracurricular Involvement</span> <br />
                Participating in clubs, sports, or other extracurricular activities provides students with opportunities to connect and collaborate with peers who share similar interests. These activities promote social interaction and the development of positive peer relationships.<br/>
                <span className="font-bold text-r-blue">Celebrate Kindness and Positivity</span> <br />
                Recognize and celebrate acts of kindness and positive interactions among students, fostering a culture of positivity and mutual support. By highlighting positive behavior, you reinforce the importance of treating others with kindness and respect.<br/>
            ...
            <section id="section3">
                ...
                <div>School counselors play a pivotal role in nurturing positive peer relationships and equipping students with essential social skills. By providing guidance, fostering empathy, and facilitating opportunities for positive interaction, counselors create an environment where students can thrive emotionally, socially, and academically. Through these strategies, students develop the skills necessary for building healthy relationships, navigating social situations, and ultimately, achieving lifelong success.
                </div>
            </section>
